...
export interface ApiAccountAccount extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'An investor entity (company/household) that owns portal data and can have multiple linked users.';
    displayName: 'Account';
    pluralName: 'accounts';
  ...
  attributes: {
    ...
    portfolioReports: Schema.Attribute.Relation<
      'oneToMany',
      'api::portfolio-report.portfolio-report'
    >;
...
export interface ApiDocumentDocument extends Struct.CollectionTypeSchema {
  collectionName: 'investor_documents';
  info: {
    description: 'A document owned by an account (LP agreements, tax slips, reports, etc.).';
  ...
  attributes: {
    ...
    fileType: Schema.Attribute.Enumeration<
      ['PDF', 'PPT', 'XLS', 'CSV', 'ZIP', 'VIDEO', 'OTHER']
    > &
      Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
...
export interface ApiInvitationInvitation extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'An admin-created invite for a new investor user, backed by a Clerk invitation.';
  ...
  attributes: {
    ...
    accepted_by_user: Schema.Attribute.Relation<
      'oneToOne',
      'plugin::users-permissions.user'
    >;
    account: Schema.Attribute.Relation<'manyToOne', 'api::account.account'>;
    clerk_invitation_id: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    invitation_url: Schema.Attribute.Text;
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    role: Schema.Attribute.Enumeration<['investor', 'admin']> &
...
export interface ApiNewsArticleNewsArticle extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'An investor news/blog post.';
    displayName: 'News';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    customDate: Schema.Attribute.Date & Schema.Attribute.Required;
    excerpt: Schema.Attribute.Text & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiNewsCategoryNewsCategory
  ...
  info: {
    description: 'A tag applied to News articles (e.g. Investment Opportunity, Company News).';
...
export interface ApiPortfolioReportPortfolioReport
  extends Struct.CollectionTypeSchema {
  collectionName: 'portfolio_reports';
  info: {
    description: 'A monthly/annual portfolio performance report owned by an account.';
    displayName: 'Portfolio Report';
    pluralName: 'portfolio-reports';
    singularName: 'portfolio-report';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    disclaimer: Schema.Attribute.Text &
      Schema.Attribute.DefaultTo<'Projected values, returns, and timelines are estimates based on current project proformas and are not guaranteed. Past performance is not indicative of future results. This portal is provided for informational purposes only and does not constitute an offer to sell, or a solicitation of an offer to buy, any security. Demo figures shown for John Doe are fictional and for illustration only. Q2 Capital Partners \u00B7 East97 Group \u00B7 Burlington, Ontario.'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::portfolio-report.portfolio-report'
    ...
    title: Schema.Attribute.String & Schema.Attribute.Required;
    type: Schema.Attribute.Enumeration<['Monthly Report', 'Annual Report']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    phase: Schema.Attribute.Enumeration<
      ['Pre-Development', 'Under Construction', 'Fully Realized']
    >;
...
export interface ApiResourceResource extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'A downloadable file attached to one or more News articles.';
  ...
  attributes: {
    category: Schema.Attribute.Enumeration<
      ['Press Release', 'Site Photos', 'Media Kit', 'Other']
    > &
      Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
declare module '@strapi/strapi' {
  export namespace Public {
    export interface ContentTypeSchemas {
      ...
      'api::portfolio-report.portfolio-report': ApiPortfolioReportPortfolioReport;
